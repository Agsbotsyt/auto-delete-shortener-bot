...
BOT_TOKEN = environ.get('BOT_TOKEN', "6056853657:AAGfb0I9-daXrJVmECdp3lkF2v1fkf7lqFk")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://te.legra.ph/file/ed3d2ad49c990c24929ca.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '@Ags_bot_update')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '@Ags_Support'))
